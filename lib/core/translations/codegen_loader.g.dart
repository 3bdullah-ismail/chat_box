...
class CodegenLoader extends AssetLoader {
  ...
  static const Map<String, dynamic> _ar = {
    ...
    "auth": {
      ...
      "signUp": {
        ...
        "signInText": "تسجيل الدخول",
        "termsAndPrivacy":
            "بالنقر على \"إنشاء حساب\"، فإنك توافق على شروط الخدمة وسياسة الخصوصية الخاصة بنا. يتم التعامل مع معالجة البيانات بدقة تقنية.",
    ...
    "chat": {
      ...
      "chatsPage": {"searchHint": "ابحث عن أشخاص"},
      "chatCard": {"chatUser": "مستخدم", "tapToStart": "اضغط لبدء الدردشة..."},
      "emptyChats": {
        "title": "لا توجد محادثات\nبعد",
        "description":
            "ابدأ محادثة جديدة للتواصل مع أصدقائك وزملائك. ستظهر رسائلك الخاصة والجماعية هنا.",
    ...
    "friends": {
      "addFriends": {
        ...
        "emptyStateDesc":
            "لم نتمكن من العثور على أي شخص يطابق بحثك. جرب البحث باسم المستخدم أو البريد الإلكتروني.",
      },
      "friendRequests": {
        "title": "طلبات الصداقة",
      ...
      "sentRequests": {
        ...
        "emptyStateDesc":
            "لم تقم بإرسال أي طلبات صداقة بعد. اذهب وابحث عن بعض الأصدقاء!",
      },
    },
    "layout": {
      "chatsTab": "المحادثات",
    ...
    "onboarding": {
      ...
      "description":
          "سيلورا تقرب الأشخاص من بعضهم من خلال محادثات بسيطة وآمنة وذات مغزى. ابق على اتصال مع الأصدقاء والعائلة والأشخاص الأهم بالنسبة لك.",
    ...
    "core": {
      "dialog": {"error": "خطأ", "success": "نجاح", "warning": "تحذير"},
      "time": {"justNow": "الآن", "minAgo": "د مضت"},
      "validation": {
  ...
  static const Map<String, dynamic> _en = {
    ...
    "chat": {
      ...
      "chatsPage": {"searchHint": "Search for people"},
      "chatCard": {
        "chatUser": "Chat User",
    ...
    "core": {
      "dialog": {"error": "Error", "success": "Success", "warning": "Warning"},
